...
class ScaleDataBuilderTest (unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._scaleDataBuilder = ScaleDataBuilder(0.5)
    ...
    def testBuildProcessedData(self) -> None:
        ...
        self._scaleDataBuilder._preprocessedData = preprocessedData
        self._scaleDataBuilder._buildProcessedData()
        solution = [[0.5], [41], [26.5], [512]]
        self.assertEquals(solution, self._scaleDataBuilder._processedData)